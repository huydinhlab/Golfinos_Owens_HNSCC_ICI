...
setwd("/Golfinos_Owen_et_al_HNSCC_ICI/SeuratObjects_dataFrames")

# Load annotation data (if needed later)
ann_cd45 <- readxl::read_excel('/Golfinos_Owen_et_al_HNSCC_ICI/SeuratObjects_dataFrames/inputs/GSE226134_CD45_10__norm (1).xlsx')
ann_cd68 <- readxl::read_excel('/Golfinos_Owen_et_al_HNSCC_ICI/SeuratObjects_dataFrames/inputs/GSE226134_CD68_10__norm.xlsx')
ann_ck <- readxl::read_excel('/Golfinos_Owen_et_al_HNSCC_ICI/SeuratObjects_dataFrames/inputs/GSE226134_CK_10__norm.xlsx')

# Load GeoMx data
t <- readRDS("/Golfinos_Owen_et_al_HNSCC_ICI/SeuratObjects_dataFrames/NanoStringGeoMxSet_objects/raw_Yale_geomx.RDS")
e <- exprs(t)
log <- log2(e+1)
test <- fData(t)
p <- pData(t)
...
litch <- readr::read_delim('/Golfinos_Owen_et_al_HNSCC_ICI/SeuratObjects_dataFrames/Using_Litchfield_Data/meta_analysis_input_data.txt')
