...
write.csv(ni.input, file = '/Golfinos_Owen_et_al_HNSCC_ICI/SeuratObjects_dataFrames/Protein_ni.input.csv')
```
...
write.csv(ni.input, file = '/Golfinos_Owen_et_al_HNSCC_ICI/SeuratObjects_dataFrames/RNA_ni.input.csv')
```
